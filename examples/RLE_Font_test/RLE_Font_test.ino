...
#include <TFT_ILI9341_ESP.h> // Graphics and font library for ILI9341 driver chip
#include <SPI.h>

TFT_ILI9341_ESP tft = TFT_ILI9341_ESP();  // Invoke library, pins defined in User_Setup.h
