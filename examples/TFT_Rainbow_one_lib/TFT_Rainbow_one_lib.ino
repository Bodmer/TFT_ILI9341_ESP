...
TFT_ILI9341_ESP tft = TFT_ILI9341_ESP();                   // Invoke custom library with default width and height

//TFT_ILI9341_ESP tft = TFT_ILI9341_ESP(240, 320);       // Could invoke custom library declaring width and height
